...
"
    ...
    >
      ...
      <div class="mt-20">
        In order to unsubscribe chat from company level, all projects need to disable chat, first.
      </div>
      <div class="mt-20">
      ...
      <el-form :model="formData" ref="form" :rules="rules">
        ...
        <el-form-item
          label="2. Please specify another chat/messaging vendors you will switch to."
          label-position="top"
          prop="switchVendors"
          required
        >
