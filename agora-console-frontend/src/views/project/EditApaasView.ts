      ...
      <div class="page-v3 edit-project" v-loading="loading">
        ...
        <div :style="showDocs ? 'width: 40%' : 'width: 100%'">
          ...
          <el-form size="small" label-width="120px" label-position="left">
            ...
            <!--环信IM配置（仅中国）-->
            <div class="project-module mb-20">
              <div class="module-item-title">{{ $t('IM') }}</div>
              <div class="module-content">
                ...
                <el-form-item :label="$t('clientId')">
                  <el-col :xs="24" :sm="24" :md="20" :lg="14" :xl="10">
                    <el-input v-model="huanxinModel.huanxin.clientId" :disabled="!huanxinModel.enabled"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item :label="$t('clientSecret')">
                  <el-col :xs="24" :sm="24" :md="20" :lg="14" :xl="10">
                    <el-input v-model="huanxinModel.huanxin.clientSecret" :disabled="!huanxinModel.enabled"></el-input>
                  </el-col>
                </el-form-item>
            ...
            <!--CDN配置-->
            <div class="project-module mb-20">
              <div class="module-item-title">{{ $t('CDN Config') }}</div>
              <div class="module-content">
...
export default class EditApaasView extends Vue {
  ...
  setDefaultVendor() {
    ...
    this.huanxinModel.huanxin.type = 2
  ...
  async changeBreadcrumb() {
    ...
    routeList.push(
      ...
      },
      {
        ...
        meta: {
          breadcrumb: 'Flexible classroom configuration',
        },
      }
    )
