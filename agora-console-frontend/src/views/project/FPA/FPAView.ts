...
import FPADetail from '@/views/project/FPA/FPADetail'
import ManualRecordsDialog from '@/views/project/FPA/ ManualRecordsDialog'
  ...
  async changeBreadcrumb() {
    ...
    routeList.push(
      ...
      },
      {
        ...
        meta: {
          breadcrumb: 'Full-Path Accelerator',
        },
      }
    )
