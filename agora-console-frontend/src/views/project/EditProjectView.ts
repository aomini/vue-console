...
import ExtensionBox from './components/extensionBox/ExtensionBox'
...
import QuickStart from '@/views/project/components/quickStart/QuickStart'
...
@Component({
  ...
  template: `
    <div>
      <div class="page-v3 edit-project v1" v-loading="loading">
        <el-row type="flex" align="middle" justify="space-between">
          <div class="d-flex align-center">
            ...
            <div :data-intro="$t('ProjectDetailIntro-1')" data-step="1" data-position="right">
              <el-breadcrumb separator="|" class="mr-10 d-inline-block">
                <el-breadcrumb-item>
                  <span v-if="vendorStage === 2" class="stage-live">{{ $t('LiveEnv') }}</span>
                  <span v-else class="stage-test">{{ $t('TestingEnv') }}</span>
                </el-breadcrumb-item>
              ...
              >
                <el-form :model="vendorInfo" size="small" ref="info" label-width="90px" label-position="left">
                  <el-form-item :label="$t('Environment')" prop="stage" class="nowrap">
                    <template>
                      <el-radio-group v-model="vendorInfo.stage" @change="stageSwitchChange">
                        <el-radio :label="3"> {{ $t('TestingEnv') }}</el-radio>
                        <el-radio :label="2"> {{ $t('LiveEnv') }}</el-radio>
                      </el-radio-group>
                    </template>
                  </el-form-item>
          ...
          <div :data-intro="$t('ProjectDetailIntro-2')" data-step="2" data-position="bottom" v-if="vendorInfo.id">
            <product-selector
              :projectId="$route.params.id"
              :default-product="vendorInfo.productTypeId"
              :default-platform="vendorInfo.platformId"
              @changeQuickStart="changeQuickStart"
            ></product-selector>
          </div>
        </el-row>
        ...
        <div class="d-flex" style="align-items: stretch">
          <div class="d-inline-block flex-1">
            <div
              class="project-module mb-20"
              :data-intro="$t('ProjectDetailIntro-4')"
              data-step="4"
            ...
            >
              ...
              <div class="module-content">
                <el-row>
                  ...
                  <el-col :span="showDocs ? 24 : 12">
                    <password-input :passwordValue="vendorInfo.key" :isDisabled="true" :size="'small'"></password-input>
                  </el-col>
                </el-row>
                <el-row :class="[showDocs ? 'mb-0' : '' ]" :gutter="20">
                  <el-col :span="24" class="project-module-label">
                  ...
                  <el-col :span="showDocs ? 24 : 6" :class="[showDocs ? 'mb-20' : '']">
                    <certificate-box
                      type="primary"
                  ...
                  <el-col v-if="!!vendorInfo.signkey" :span="showDocs ? 24 : 6" :class="[showDocs ? 'mb-20' : 'mr-20']">
            ...
            <div class="project-module">
              ...
              <div class="module-content">
                <template v-for="extension in extensionsMetaData">
                  <el-row class="extension-title" :id="extension.nameEn.replace(/\\s/g,'-')">
                    {{ isCNLang ? extension.nameCn : extension.nameEn }}
                  </el-row>
          ...
          <div class="d-inline-block project-module ml-20 project-doc-unfold" v-show="showDocs">
            <quick-start :docs-link="docsLink" :demo-list="demoList" @closeDocs="showDocs = false"></quick-start>
          </div>
          <transition>
        ...
        >
          <div class="p-2">
            <div>
              <span>{{ $t('EnableModerationDesc') }} </span>
            </div>
            <div class="mt-20 text-right">
