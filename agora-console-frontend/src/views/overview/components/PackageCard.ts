...
@Component({
  template: `
    <div class="card-box package-card" v-loading="loading">
      <div class="card-header border-bottom pb-10 mb-24">
        <div class="header-title">
          <span class="heading-dark-03 f-16">{{ $t('Minutes Package') }}</span>
        </div>
      ...
      <div class="marketplace">
        <div class="d-flex space-between">
          <div class="flex-1 text-center border-8 mr-20 p-16 overflow-hidden" style="background-color: #E8EFFF">
            ...
            <console-button class="console-btn-primary mt-13" @click="jumpToPackage">{{
              $t('Purchase Now')
            }}</console-button>
          </div>
          <div class="flex-1 text-center border-8 p-16 overflow-hidden" style="background-color: #EFE8FF">
          ...
          <!--          <div class="flex-1 text-center border-8">-->
          <!--            <img :src="videoImg" class="w-100px border-50" />-->
          ...
          <!--            <console-button class="console-btn-primary mt-13" @click="jumpToPackage">{{ $t('View') }}</console-button>-->
          <!--          </div>-->
        </div>
      </div>
    </div>
