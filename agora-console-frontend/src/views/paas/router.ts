...
import Layout from '@/views/paas/LayoutView'
import { user } from '@/services/user'
import { i18n } from '@/i18n-setup'
import { Message } from 'element-ui'
import VendorApplyList from '@/views/paas/vendorApply/VendorApplyList'
import VendorApply from '@/views/paas/vendorApply/VendorApply'
import CNIntroduceView from '@/views/paas/newProductView/CNIntroduceView'
import LicenseView from '@/views/paas/newProductView/LicenseView'
// import ENIntroduceView from '@/views/paas/newProductView/ENIntroduceView'
