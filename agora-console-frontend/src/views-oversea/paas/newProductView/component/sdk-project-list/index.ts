...
@Component({
  template: ` <div class="mini-project-list">
    <div class="list-title cursor-pointer" v-if="showTitle" @click="setShowStep()">
    ...
    <el-dialog :title="$t('Config')" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="confirmAction(selectProject, 0)">Save</el-button>
      </div>
    </el-dialog>
  </div>`,
})
